function [obsNamesDisp, prcNamesDisp, obsNamesList, prcNamesList] = modelNames_PAL_ASD()
...
% Make sure it is the same number as the number of the display names!
 obsNamesList = ["tapas_logrt_linear_binary", "tapas_logrt_linear_binary"];
