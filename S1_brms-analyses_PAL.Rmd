...
The model does not support our hypothesis, neither regarding a decreased difference in reaction time to expected and unexpected outcomes in adults with ASD compared to adults without any psychiatric diagnoses (*estimate* = `r round(h1b$hypothesis$Estimate,2)` [`r round(h1b$hypothesis$CI.Lower,2)`, `r round(h1b$hypothesis$CI.Upper,2)`], *posterior probability* = `r round(h1b$hypothesis$Post.Prob*100,2)`%) nor a difference in reaction time to expected and unexpected outcomes in adults with ASD compared to adults without any psychiatric diagnoses (*estimate* = `r round(h1c$hypothesis$Estimate,2)` [`r round(h1c$hypothesis$CI.Lower,2)`, `r round(h1c$hypothesis$CI.Upper,2)`], *posterior probability* = `r round(h1c$hypothesis$Post.Prob*100,2)`%). 
