function [logp, yhat, res] = emba_logrt_linear_binary_ABC(r, infStates, ptrans)
...
% Epsilon 3 (aka precision weighted prediction error)
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
eps3   = infStates(:,3,5);
eps3(r.irr) = [];
...
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
logrt = be0 +be1.*surp +be2.*bernv +be3.*inferv +be4.*pv +be5.*eps3;
