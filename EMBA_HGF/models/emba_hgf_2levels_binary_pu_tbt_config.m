function c = emba_hgf_binary_pu_tbt_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% scaling of x_i+1).
c.logkamu = [log(1), -Inf];   % ADJUSTED: fixed to so that log(k2) is 0
c.logkasa = [     0,      0];
...
% Undefined (therefore NaN) at the first level.
c.ommu = [NaN,  -5,  -6];
c.omsa = [NaN, 4^2,   0]; % ADJUSTED: variance fixed to 0
...
c.prc_fun = @emba_hgf_binary_pu_tbt;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @emba_hgf_binary_pu_tbt_transp;
